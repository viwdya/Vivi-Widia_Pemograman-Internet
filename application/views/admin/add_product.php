                    ...
                    <div class="row">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="kategori" name="kategori">
                                        ...
                                        <option value="alat_kopi">Alat Kopi</option>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="satuan" name="satuan" placeholder="pcs, box, dll">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="foto-section">
                                ...
                                <button type="submit" class="btn btn-primary btn-block mt-4">Tambah Produk Baru</button>
                            </div>
                        </div>
                    </div>
                </form>
